...
class RouteLoader {
    static loadRoutes(app_1) {
        return __awaiter(this, arguments, void 0, function* (app, basePath = "/api") {
            ...
            for (const file of routeFiles) {
                if (file.endsWith("Routes.ts") || file.endsWith("Routes.js")) {
                    const routeModule = yield Promise.resolve(`${path_1.default.join(routesPath, file)}`).then(s => __importStar(require(s)));
